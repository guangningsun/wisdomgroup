...
class PresentInfo(models.Model):
    ...
    activity_name = models.ForeignKey('ActivityInfo',verbose_name='活动名称',related_name='activity_name',on_delete=models.CASCADE)
    ...
    present_desc = models.CharField(max_length=200,verbose_name='礼品描述')
    is_draw = models.BooleanField(verbose_name='是否已领取',default="False")
...
class UserInfo(models.Model):
    ...
    categary = models.CharField(max_length=200,verbose_name='所属单位')
    apartment = models.CharField(max_length=200,verbose_name='所属公寓')
    room = models.CharField(max_length=200,verbose_name='所在宿舍')
    sex = models.CharField(max_length=200,verbose_name='性别')
    national = models.CharField(max_length=200,verbose_name='民族')
